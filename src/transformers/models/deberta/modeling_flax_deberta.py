...
class FlaxContextPooler(nn.Module):
    ...
    def setup(self):
        ...
        self.dropout = StableDropout(self.config.pooler_dropout)
...
class FlaxDebertaLayerNorm(nn.Module):
    ...
    def setup(self):
        self.weight = nn.Parameter(jnp.ones(size))
        self.bias = nn.Parameter(jnp.zeros(size))
    ...
    def forward(self, hidden_states):
        ...
        hidden_states = (hidden_states - mean) / jnp.sqrt(variance + self.variance_epsilon)
...
class DebertaSelfOutput(nn.Module):
    def __init__(self, config):
        ...
        self.LayerNorm = FlaxDebertaLayerNorm(config.hidden_size, config.layer_norm_eps)
...
class DebertaForSequenceClassification(DebertaPreTrainedModel):
    def __init__(self, config):
        ...
        self.deberta = DebertaModel(config)
        self.pooler = FlaxContextPooler(config)
